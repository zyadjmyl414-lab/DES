...
//   const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=90x90&data=${encodeURIComponent(
//     `${name} | Price: ${price} | Barcode: ${barcodeValue}`,
//   )}`;
//   qrImage.src = qrUrl;
// }
...
//   loadImage(productImageInput, previewImage);
// });

// logoInput.addEventListener("change", function () {
//   loadImage(logoInput, footerLogo);
// });
...
//     link.download = "product-price-tag.png";
